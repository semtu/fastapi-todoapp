...
class LoginForm:
    ...
    async def create_oauth_form(self):
        ...
        self.username = form.get("email") #oauth needs the name 'email'to properly work. But the email will be saved as username
...
async def login(request: Request, db: Session = Depends(get_db)):
    try:
        ...
        valiidate_user_cookie = await login_for_access_token(response, form, db)

        if not valiidate_user_cookie:
